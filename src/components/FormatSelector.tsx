        ...
        {formats.map((format) => (
          ...
          >
            <div className="flex flex-col items-center space-y-2">
              <div className={`p-2 rounded-lg bg-gradient-to-r ${format.color} text-white`}>{format.icon}</div>
              <span className="font-semibold text-gray-800">{format.label}</span>
            </div>

            {value === format.value && (
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-slate-600 rounded-full animate-pulse" />
            )}
          </button>
        ))}
      </div>
      ...
      <div className="bg-gray-50 rounded-xl p-4 space-y-3">
        <div className="grid grid-cols-3 gap-4 text-xs">
          <div className="text-center">
            <div className="text-gray-600 mb-1">Compatibilidad</div>
            <CompatibilityBar
          ...
          <div className="text-center">
            <div className="text-gray-600 mb-1">Calidad</div>
            <CompatibilityBar
          ...
          <div className="text-center">
            <div className="text-gray-600 mb-1">Tamaño</div>
            <CompatibilityBar
